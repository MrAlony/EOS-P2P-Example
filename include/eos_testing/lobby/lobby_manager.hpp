...
public:
    ...
    /**
     * Force a refresh of the cached lobby state from EOS.
     * Useful in test apps where timing races can leave join/member info stale.
     */
    void sync_current_lobby();
...
#ifndef EOS_STUB_MODE
    EOS_NotificationId m_lobby_update_notification_id = EOS_INVALID_NOTIFICATIONID;
    EOS_NotificationId m_lobby_member_update_notification_id = EOS_INVALID_NOTIFICATIONID;
    EOS_NotificationId m_lobby_member_status_notification_id = EOS_INVALID_NOTIFICATIONID;
#endif
};
